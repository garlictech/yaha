...
export const searchByRadiusResolver = (deps: SearchResolverDeps) => (
...
export const searchInShapeResolver = (deps: SearchResolverDeps) => (
...
export const searchInEnvelopeResolver = (deps: SearchResolverDeps) => (
...
export const searchInMultipolygonResolver = (deps: SearchResolverDeps) => (
...
export const searchAroundHikeResolver = (deps: SearchResolverDeps) => (
