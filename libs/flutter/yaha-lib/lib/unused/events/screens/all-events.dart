                ...
                return SafeArea(
                  child: GridView.count(
                    ...
                    children: const [
                      ...
                      EventBox(
                          background:
                              'packages/flutter_yaha_lib/assets/images/nagy-egedi-tura-kupa.png',
                          nextScreen: EventDetailScreen()),
                      EventBox(
                          background:
                              'packages/flutter_yaha_lib/assets/images/bukk-instant-kupa.png',
                          nextScreen: EventDetailScreen()),
                      EventBox(
                          background:
                              'packages/flutter_yaha_lib/assets/images/bukki-kihivas.png',
                          nextScreen: EventDetailScreen()),
                      EventBox(
                          background:
