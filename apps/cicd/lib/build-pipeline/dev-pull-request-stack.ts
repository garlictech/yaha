          ...
          phases: {
            ...
            build: {
              commands: [
                ...
                `yarn nx affected:test --base=${stage} --exclude="mobile-app" --exclude="integration-tests-universal" ${generatedLibExcludes} --codeCoverage --coverageReporters=clover`,
                `yarn nx test mobile-app`,
