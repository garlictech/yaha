...
/** This is an auto generated class representing the HikeStopData type in your schema. */
@immutable
class HikeStopData {
  final String? _poiId;
  ...
  const HikeStopData._internal({required poiId, description}): _poiId = poiId, _description = description;
  
  factory HikeStopData({required String poiId, List<TextualDescription>? description}) {
    return HikeStopData._internal(
      poiId: poiId,
  ...
  HikeStopData copyWith({String? poiId, List<TextualDescription>? description}) {
    return HikeStopData._internal(
      poiId: poiId ?? this.poiId,
      description: description ?? this.description);
  }
  
  HikeStopData.fromJson(Map<String, dynamic> json)  
    : _poiId = json['poiId'],
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "HikeStopData";
    modelSchemaDefinition.pluralName = "HikeStopData";
