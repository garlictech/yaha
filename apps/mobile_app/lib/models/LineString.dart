...
/** This is an auto generated class representing the LineString type in your schema. */
@immutable
class LineString {
  final String? _type;
  ...
  const LineString._internal({required type, required coordinates}): _type = type, _coordinates = coordinates;
  
  factory LineString({required String type, required List<double> coordinates}) {
    return LineString._internal(
      type: type,
  ...
  LineString copyWith({String? type, List<double>? coordinates}) {
    return LineString._internal(
      type: type ?? this.type,
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "LineString";
    modelSchemaDefinition.pluralName = "LineStrings";
