...
class RouteData {
  ...
  const RouteData._internal({required distance, required uphill, required downhill, required averageTime, required score, required difficulty, required bounds, required isRoundTrip, required poiSearchBox}): _distance = distance, _uphill = uphill, _downhill = downhill, _averageTime = averageTime, _score = score, _difficulty = difficulty, _bounds = bounds, _isRoundTrip = isRoundTrip, _poiSearchBox = poiSearchBox;
  
  factory RouteData({required int distance, required int uphill, required int downhill, required int averageTime, required int score, required int difficulty, required BoundingBox bounds, required bool isRoundTrip, required BoundingBox poiSearchBox}) {
  ...
  RouteData copyWith({int? distance, int? uphill, int? downhill, int? averageTime, int? score, int? difficulty, BoundingBox? bounds, bool? isRoundTrip, BoundingBox? poiSearchBox}) {
    return RouteData._internal(
  ...
  Map<String, dynamic> toJson() => {
    'distance': _distance, 'uphill': _uphill, 'downhill': _downhill, 'averageTime': _averageTime, 'score': _score, 'difficulty': _difficulty, 'bounds': _bounds?.toJson(), 'isRoundTrip': _isRoundTrip, 'poiSearchBox': _poiSearchBox?.toJson()
  };
