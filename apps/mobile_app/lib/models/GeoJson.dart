...
/** This is an auto generated class representing the GeoJson type in your schema. */
@immutable
class GeoJson {
  final String? _type;
  ...
  const GeoJson._internal({required type, required coordinates}): _type = type, _coordinates = coordinates;
  
  factory GeoJson({required String type, required List<double> coordinates}) {
    return GeoJson._internal(
      type: type,
  ...
  GeoJson copyWith({String? type, List<double>? coordinates}) {
    return GeoJson._internal(
      type: type ?? this.type,
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "GeoJson";
    modelSchemaDefinition.pluralName = "GeoJsons";
