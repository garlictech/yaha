...
class ImagesAlongHikeNotifier extends ChangeNotifier {
  ...
  final String hikeId;
  final ChangeNotifierProviderRef<ImagesAlongHikeNotifier> ref;

  ImagesAlongHikeNotifier({required this.hikeId, required this.ref}) {
    refreshImages();
  }

  void refreshImages() async {
    final imageUsecases = ref.read(imageUsecasesProvider);
    imageUrls = await imageUsecases
        .getImagesAlongHike(hikeId)
