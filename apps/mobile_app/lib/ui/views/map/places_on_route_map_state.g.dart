...
class PlacesOnRouteMapState$ {
  static final offroutePois = Lens<PlacesOnRouteMapState, List<Poi>?>(
  ...
  static final hike = Lens<PlacesOnRouteMapState, Hike?>(
