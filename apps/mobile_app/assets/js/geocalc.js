(() => {
  ...
  var require_rbush_min = __commonJS({
    'node_modules/geojson-rbush/node_modules/rbush/rbush.min.js'(
      ...
      !(function (t, i) {
            ...
            for (; a3 > e3; ) {
              if (a3 - e3 > 600) {
                var o2 = a3 - e3 + 1,
                  s2 = r3 - e3 + 1,
                  l2 = Math.log(o2),
                  f2 = 0.5 * Math.exp((2 * l2) / 3),
                  u2 =
                    0.5 *
                    Math.sqrt((l2 * f2 * (o2 - f2)) / o2) *
                    (s2 - o2 / 2 < 0 ? -1 : 1),
                  m2 = Math.max(e3, Math.floor(r3 - (s2 * f2) / o2 + u2)),
                  c2 = Math.min(
                    a3,
                    Math.floor(r3 + ((o2 - s2) * f2) / o2 + u2),
                  );
                t3(n2, r3, m2, c2, h3);
              }
              var p2 = n2[r3],
                ...
                x = a3;
              for (
                i(n2, e3, r3), h3(n2[a3], p2) > 0 && i(n2, e3, a3);
                d2 < x;
              ...
              h3(n2[e3], p2) === 0 ? i(n2, e3, x) : i(n2, ++x, a3),
                x <= r3 && (e3 = x + 1),
                r3 <= x && (a3 = x - 1);
            }
        ...
        function o(t2, i2) {
          return (
            (t2.minX = Math.min(t2.minX, i2.minX)),
            (t2.minY = Math.min(t2.minY, i2.minY)),
            (t2.maxX = Math.max(t2.maxX, i2.maxX)),
            (t2.maxY = Math.max(t2.maxY, i2.maxY)),
            t2
          );
        }
        function s(t2, i2) {
        ...
        return (
          ...
          (r.prototype.collides = function (t2) {
            ...
            for (var n2 = []; i2; ) {
              for (var r2 = 0; r2 < i2.children.length; r2++) {
                var e2 = i2.children[r2],
                  a2 = i2.leaf ? this.toBBox(e2) : e2;
                if (c(t2, a2)) {
          ...
          (r.prototype._all = function (t2, i2) {
            for (var n2 = []; t2; )
              t2.leaf
                ? i2.push.apply(i2, t2.children)
                : n2.push.apply(n2, t2.children),
                (t2 = n2.pop());
            return i2;
          }),
          (r.prototype._build = function (t2, i2, n2, r2) {
            ...
            r2 ||
              ((r2 = Math.ceil(Math.log(h2) / Math.log(o2))),
              (o2 = Math.ceil(h2 / Math.pow(o2, r2 - 1)))),
              ((e2 = p([])).leaf = false),
              (e2.height = r2);
            var s2 = Math.ceil(h2 / o2),
              l2 = s2 * Math.ceil(Math.sqrt(o2));
          ...
          (r.prototype._chooseSubtree = function (t2, i2, n2, r2) {
            for (; r2.push(i2), !i2.leaf && r2.length - 1 !== n2; ) {
              for (
                var e2 = 1 / 0, a2 = 1 / 0, h2 = void 0, o2 = 0;
                o2 < i2.children.length;
                o2++
              ) {
                var s2 = i2.children[o2],
                  l2 = f(s2),
                  u2 =
                    ((m2 = t2),
                    (c2 = s2),
                    (Math.max(c2.maxX, m2.maxX) - Math.min(c2.minX, m2.minX)) *
                      (Math.max(c2.maxY, m2.maxY) -
                        Math.min(c2.minY, m2.minY)) -
                      l2);
                u2 < a2
                  ? ((a2 = u2), (e2 = l2 < e2 ? l2 : e2), (h2 = s2))
                  : u2 === a2 && l2 < e2 && ((e2 = l2), (h2 = s2));
              }
              i2 = h2 || i2.children[0];
            }
            var m2, c2;
          ...
          (r.prototype._insert = function (t2, i2, n2) {
            var r2 = n2 ? t2 : this.toBBox(t2),
              e2 = [],
              a2 = this._chooseSubtree(r2, this.data, i2, e2);
            for (
              a2.children.push(t2), o(a2, r2);
              i2 >= 0 && e2[i2].children.length > this._maxEntries;
          ...
          (r.prototype._split = function (t2, i2) {
            var n2 = t2[i2],
              r2 = n2.children.length,
              e2 = this._minEntries;
            this._chooseSplitAxis(n2, e2, r2);
            var h2 = this._chooseSplitIndex(n2, e2, r2),
              o2 = p(n2.children.splice(h2, n2.children.length - h2));
            (o2.height = n2.height),
              (o2.leaf = n2.leaf),
              a(n2, this.toBBox),
              a(o2, this.toBBox),
              i2 ? t2[i2 - 1].children.push(o2) : this._splitRoot(n2, o2);
          }),
          ...
          (r.prototype._chooseSplitIndex = function (t2, i2, n2) {
            for (
              var r2, e2, a2, o2, s2, l2, u2, m2 = 1 / 0, c2 = 1 / 0, p2 = i2;
              p2 <= n2 - i2;
              p2++
            ) {
              var d2 = h(t2, 0, p2, this.toBBox),
                ...
                v =
                  ...
                  (l2 = void 0),
                  (u2 = void 0),
                  (o2 = Math.max(e2.minX, a2.minX)),
                  (s2 = Math.max(e2.minY, a2.minY)),
                  (l2 = Math.min(e2.maxX, a2.maxX)),
                  (u2 = Math.min(e2.maxY, a2.maxY)),
                  Math.max(0, l2 - o2) * Math.max(0, u2 - s2)),
                M = f(d2) + f(x);
              v < m2
                ? ((m2 = v), (r2 = p2), (c2 = M < c2 ? M : c2))
                : v === m2 && M < c2 && ((c2 = M), (r2 = p2));
            }
            return r2 || n2 - i2;
          }),
          (r.prototype._chooseSplitAxis = function (t2, i2, n2) {
            var r2 = t2.leaf ? this.compareMinX : s,
              e2 = t2.leaf ? this.compareMinY : l;
            this._allDistMargin(t2, i2, n2, r2) <
              this._allDistMargin(t2, i2, n2, e2) && t2.children.sort(r2);
          }),
          ...
          (r.prototype._condense = function (t2) {
            for (var i2 = t2.length - 1, n2 = void 0; i2 >= 0; i2--)
              t2[i2].children.length === 0
                ? i2 > 0
                  ? (n2 = t2[i2 - 1].children).splice(n2.indexOf(t2[i2]), 1)
                  : this.clear()
                : a(t2[i2], this.toBBox);
          }),
          r
  ...
  var require_js = __commonJS({
    'node_modules/@turf/helpers/dist/js/index.js'(exports) {
      ...
      function convertLength(length2, originalUnit, finalUnit) {
        ...
        return radiansToLength2(
          lengthToRadians2(length2, originalUnit),
          finalUnit,
        );
      }
  ...
  var require_js2 = __commonJS({
    'node_modules/@turf/meta/dist/js/index.js'(exports) {
      ...
      function flattenEach2(geojson, callback) {
        geomEach2(
          geojson,
          function (geometry, featureIndex, properties, bbox2, id) {
      ...
      function segmentEach2(geojson, callback) {
        flattenEach2(
          geojson,
          function (feature2, featureIndex, multiFeatureIndex) {
            var segmentIndex = 0;
        ...
        flattenEach2(
          ...
          function (feature2, featureIndex, multiFeatureIndex) {
            ...
            switch (type) {
              case 'LineString':
                if (
                  callback(feature2, featureIndex, multiFeatureIndex, 0, 0) ===
                  false
                )
                  return false;
                break;
      ...
      function findSegment(geojson, options) {
        ...
        switch (geometry.type) {
          ...
          case 'MultiLineString':
            ...
            if (segmentIndex < 0)
              segmentIndex =
                coords[multiFeatureIndex].length + segmentIndex - 1;
            return helpers.lineString(
              [
    ...
    'node_modules/geojson-rbush/index.js'(exports, module) {
      ...
      function geojsonRbush(maxEntries) {
        ...
        tree.search = function (geojson) {
          var features = rbush2.prototype.search.call(
            this,
            this.toBBox(geojson),
          );
  ...
  var require_internal = __commonJS({
    'node_modules/fp-ts/lib/internal.js'(exports) {
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.fromReadonlyNonEmptyArray =
        exports.has =
        exports.emptyRecord =
  ...
  var require_Ord = __commonJS({
    'node_modules/fp-ts/lib/Ord.js'(exports) {
      ...
      var min = function (O2) {
        return function (first, second) {
          return first === second || O2.compare(first, second) < 1
            ? first
            : second;
        };
      };
  ...
  var require_Option = __commonJS({
    'node_modules/fp-ts/lib/Option.js'(exports) {
      ...
      exports.guard = /* @__PURE__ */ Zero_1.guard(
        exports.Zero,
        exports.Pointed,
      );
      exports.Alternative = {
      ...
      var defaultSeparated = /* @__PURE__ */ Separated_1.separated(
        exports.none,
        exports.none,
      );
      var separate = function (ma) {
        return exports.isNone(ma)
          ? defaultSeparated
          : Separated_1.separated(
              exports.getLeft(ma.value),
              exports.getRight(ma.value),
            );
      };
      ...
      var _wither = /* @__PURE__ */ Witherable_1.witherDefault(
        exports.Traversable,
        exports.Compactable,
      );
      var _wilt = /* @__PURE__ */ Witherable_1.wiltDefault(
        exports.Traversable,
        exports.Compactable,
      );
      ...
      exports.fromEitherK = /* @__PURE__ */ FromEither_1.fromEitherK(
        exports.FromEither,
      );
      exports.chainEitherK = /* @__PURE__ */ FromEither_1.chainEitherK(
        exports.FromEither,
        exports.Chain,
      );
      ...
      var chainNullableK = function (f) {
        return function (ma) {
          return exports.isNone(ma)
            ? exports.none
            : exports.fromNullable(f(ma.value));
        };
      };
      exports.chainNullableK = chainNullableK;
      exports.toNullable = /* @__PURE__ */ exports.match(
        function_1.constNull,
        function_1.identity,
      );
      exports.toUndefined = /* @__PURE__ */ exports.match(
      ...
      exports.getApplySemigroup = /* @__PURE__ */ Apply_1.getApplySemigroup(
        exports.Apply,
      );
      exports.getApplyMonoid =
        /* @__PURE__ */ Applicative_1.getApplicativeMonoid(exports.Applicative);
  ...
  function length(geojson, options) {
    ...
    return segmentReduce(
      geojson,
      function (previousValue, segment) {
      ...
      for (var i = 0; i < coords.length - 1; i++) {
        ...
        if (intersect.features.length > 0) {
          ...
          intersectPt.properties.location =
            length2 + es_default(start, intersectPt, options);
        }
  ...
  function distanceOnLine(start, end, path) {
    ...
    const snappedPathLength =
      length(pathBetweenSnappedPoints, { units: 'kilometers' }) * 1e3;
    return startDistanceFromPath + endDistanceFromPath + snappedPathLength;
  }
  var lineLengthInMeters = lineCoordinates =>
    O.tryCatch(
  ...
  var lineStringLengthInMeters = line => {
    ...
    return (0, import_function.pipe)(
      O.fromNullable(
        (_a = line == null ? void 0 : line.geometry) == null
          ? void 0
          : _a.coordinates,
      ),
