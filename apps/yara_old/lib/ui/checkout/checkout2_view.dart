...
import 'package:yara/viewobject/holder/coupon_discount_holder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<UserProvider>(builder:
      ...
      couponDiscountProvider = Provider.of<CouponDiscountProvider>(context,
          listen: false);
      provider = Provider.of<DeliveryCostProvider>(context, listen: false);// Listen : False is important.
