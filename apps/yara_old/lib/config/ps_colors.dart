...
class PsColors {
  ...
  /// Common Theme
  ///
  static const Color _c_main_color = Color(0xFFD60665);
  static const Color _c_main_light_color = Color(0xFFFDE8F2);
  static const Color _c_main_dark_color = Color(0xFF760036);
