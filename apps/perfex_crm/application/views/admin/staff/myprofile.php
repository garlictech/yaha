            ...
            <div class="col-md-5<?php echo $this->input->get('notifications') ? ' hide' : ''; ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="button-group mtop10 pull-right">
                            ...
                            <a href="<?php echo html_escape($staff_p->facebook); ?>" target="_blank"
                                class="btn btn-default btn-icon"><i class="fa-brands fa-facebook-f"></i></a>
                            <?php } ?>
                            <?php if (!empty($staff_p->linkedin)) { ?>
                            <a href="<?php echo html_escape($staff_p->linkedin); ?>" class="btn btn-default btn-icon"><i
                            ...
                            <a href="skype:<?php echo html_escape($staff_p->skype); ?>" data-toggle="tooltip"
                                ...
                                class="btn btn-default btn-icon"><i class="fa-brands fa-skype"></i></a>
                            <?php } ?>
                        ...
                        <?php echo staff_profile_image($staff_p->staffid, ['staff-profile-image-thumb'], 'thumb'); ?>
                        <div class="profile mtop20 display-inline-block">
                            ...
                            <p class="display-block"><i class="fa-regular fa-envelope"></i> <a
                                    href="mailto:<?php echo $staff_p->email; ?>"><?php echo $staff_p->email; ?></a></p>
              ...
              foreach ($staff_departments as $staff_department) {
                  if ($staff_department['departmentid'] == $department['departmentid']) { ?>
                                <div class="label label-info"><?php echo $staff_department['name']; ?></div>
                                <?php }
              }
             ?>
                                <?php } ?>
                        ...
                        <?php if (($staff_p->staffid == get_staff_user_id() || is_admin()) && !$this->input->get('notifications')) { ?>
                        <h4 class="tw-mt-10 tw-font-semibold tw-text-lg tw-text-neutral-700">
