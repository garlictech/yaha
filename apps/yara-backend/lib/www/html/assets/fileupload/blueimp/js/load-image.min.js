  ...
  (b.isInstanceOf = function (a, b) {
    ...
    (b.getTransformedOptions = function (a, b) {
      ...
      return (
        ...
        e / f > g
          ? ((c.maxWidth = f * g), (c.maxHeight = f))
          : ((c.maxWidth = e), (c.maxHeight = e / g)),
        c
      );
    }),
    ...
    (b.scale = function (a, c) {
      ...
      return (
        n &&
          ...
          c.sourceWidth
            ? ((h = c.sourceWidth),
              void 0 !== c.right && void 0 === c.left && (j = o - h - c.right))
            : (h = o - j - (c.right || 0)),
          c.sourceHeight
            ? ((i = c.sourceHeight),
              void 0 !== c.bottom && void 0 === c.top && (k = p - i - c.bottom))
            : (i = p - k - (c.bottom || 0)),
          (q = h),
          (r = i)),
        (d = c.maxWidth),
        ...
        n && d && e && c.crop
          ? ((q = d),
            ...
            0 > l
              ? ((i = (e * h) / d),
                void 0 === c.top && void 0 === c.bottom && (k = (p - i) / 2))
              : l > 0 &&
                ((h = (d * i) / e),
                void 0 === c.left && void 0 === c.right && (j = (o - h) / 2)))
          : ((c.contain || c.cover) && ((f = d = d || f), (g = e = e || g)),
            c.cover ? (t(), s()) : (s(), t())),
        n
          ? ((m.width = q),
            (m.height = r),
            b.transformCoordinates(m, c),
            b.renderImageToCanvas(m, a, j, k, h, i, 0, 0, q, r))
          : ((a.width = q), (a.height = r), a)
      );
    }),
  ...
  (function (a) {
    ...
    if (
      ...
      (a.detectSubsampling = function (a) {
        var b, c;
        return a.width * a.height > 1048576
          ? ((b = document.createElement('canvas')),
            (b.width = b.height = 1),
            (c = b.getContext('2d')),
            c.drawImage(a, -a.width + 1, 0),
        ...
        (a.renderImageToCanvas = function (c, d, e, f, g, h, i, j, k, l) {
          if ('image/jpeg' === d._type) {
            ...
            if (
              ...
              (r.height = s),
              q.save(),
              (m = a.detectSubsampling(d)),
              m && ((e /= 2), (f /= 2), (g /= 2), (h /= 2)),
              (n = a.detectVerticalSquash(d, m)),
              m || 1 !== n)
            ) {
              for (
                f *= n,
                ...
                for (i = 0, o = 0; g > o; )
                  t.clearRect(0, 0, s, s),
                    t.drawImage(d, e, f, g, h, -o, -p, g, h),
                    q.drawImage(r, 0, 0, s, s, i, j, k, l),
                    (o += s),
                    (i += k);
                (p += s), (j += l);
              }
  ...
  (function (a) {
    ...
    (a.hasCanvasOption = function (c) {
      ...
      (a.getTransformedOptions = function (b, c) {
        ...
        return (
          g.orientation > 4 &&
            ((e.maxWidth = g.maxHeight),
            (e.maxHeight = g.maxWidth),
            (e.minWidth = g.minHeight),
            (e.minHeight = g.minWidth),
            (e.sourceWidth = g.sourceHeight),
            (e.sourceHeight = g.sourceWidth)),
          e
        );
      });
  }),
  ...
  (function (a) {
    ...
    (a.ExifMap = function () {
      ...
      (a.parseExifTags = function (a, b, c, d, e) {
        ...
        if (
          ((f = a.getUint16(c, d)), (g = c + 2 + 12 * f), g + 4 > a.byteLength)
        )
          ...
          if (1165519206 === b.getUint32(c + 4)) {
            ...
            (h = b.getUint32(j + 4, g)),
              ...
              h &&
                ...
                ((i = { exif: {} }),
                (h = a.parseExifTags(b, j, j + h, g, i)),
                i.exif[513] &&
                  (e.exif.Thumbnail = a.getExifThumbnail(
                    b,
                    j + i.exif[513],
                    i.exif[514],
                  ))),
              e.exif[34665] &&
                !f.disableExifSub &&
                a.parseExifTags(b, j, j + e.exif[34665], g, e),
              e.exif[34853] &&
                !f.disableExifGps &&
                a.parseExifTags(b, j, j + e.exif[34853], g, e);
          }
        }
      }),
      ...
      (a.ExifMap.prototype.getText = function (a) {
        ...
        switch (a) {
          ...
          case 'ComponentsConfiguration':
            return (
              this.stringValues[a][b[0]] +
              this.stringValues[a][b[1]] +
              this.stringValues[a][b[2]] +
              this.stringValues[a][b[3]]
            );
          case 'GPSVersionID':
      ...
      (a.ExifMap.prototype.getAll = function () {
        ...
        for (a in this)
          this.hasOwnProperty(a) &&
            ((b = this.tags[a]), b && (c[b] = this.getText(b)));
        return c;
      });
  });
