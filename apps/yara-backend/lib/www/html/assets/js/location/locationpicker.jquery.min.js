...
!(function (a) {
  ...
  function f(b, c) {
    b &&
      (b.radiusInput &&
        b.radiusInput.on('change', function (b) {
          b.originalEvent &&
            ((c.radius = a(this).val()),
            h.setPosition(c, c.location, function (a) {
              a.settings.onchanged.apply(c.domContainer, [
                h.locationFromLatLng(a.location),
                a.radius,
                !1,
              ]);
            }));
      ...
      b.locationNameInput &&
        c.settings.enableAutocomplete &&
        ((c.autocomplete = new google.maps.places.Autocomplete(
          b.locationNameInput.get(0),
        )),
        google.maps.event.addListener(
          ...
          function () {
            ...
            return a.geometry
              ? void h.setPosition(c, a.geometry.location, function (a) {
                  e(b, a),
                    a.settings.onchanged.apply(c.domContainer, [
                      h.locationFromLatLng(a.location),
                      a.radius,
      ...
      b.latitudeInput &&
        b.latitudeInput.on('change', function (b) {
          b.originalEvent &&
            h.setPosition(
              c,
              new google.maps.LatLng(a(this).val(), c.location.lng()),
              function (a) {
                a.settings.onchanged.apply(c.domContainer, [
                  h.locationFromLatLng(a.location),
                  a.radius,
      ...
      b.longitudeInput &&
        b.longitudeInput.on('change', function (b) {
          b.originalEvent &&
            h.setPosition(
              c,
              new google.maps.LatLng(c.location.lat(), a(this).val()),
              function (a) {
                a.settings.onchanged.apply(c.domContainer, [
                  h.locationFromLatLng(a.location),
                  a.radius,
  ...
  var h = {
    drawCircle: function (b, c, d, e) {
      return (
        null != b.circle && b.circle.setMap(null),
        d > 0
          ? ((d *= 1),
            (e = a.extend(
              {
    ...
    setPosition: function (a, b, c) {
      (a.location = b),
        ...
        a.settings.enableReverseGeocode
          ? a.geodecoder.geocode({ latLng: a.location }, function (b, d) {
              d == google.maps.GeocoderStatus.OK &&
                b.length > 0 &&
                ((a.locationName = b[0].formatted_address),
                (a.addressComponents = h.address_component_from_google_geocode(
    ...
    address_component_from_google_geocode: function (a) {
      for (var b = {}, c = a.length - 1; c >= 0; c--) {
        var d = a[c];
        d.types.indexOf('postal_code') >= 0
          ? (b.postalCode = d.short_name)
          : d.types.indexOf('street_number') >= 0
          ? (b.streetNumber = d.short_name)
          : d.types.indexOf('route') >= 0
          ? (b.streetName = d.short_name)
          : d.types.indexOf('locality') >= 0
          ? (b.city = d.short_name)
          : d.types.indexOf('sublocality') >= 0
          ? (b.district = d.short_name)
          : d.types.indexOf('administrative_area_level_1') >= 0
          ? (b.stateOrProvince = d.short_name)
          : d.types.indexOf('country') >= 0 && (b.country = d.short_name);
      }
      return (
        (b.addressLine1 = [b.streetNumber, b.streetName].join(' ').trim()),
        (b.addressLine2 = ''),
        b
      );
    },
  ...
  (a.fn.locationpicker = function (i, j) {
    if ('string' == typeof i) {
      ...
      switch (i) {
        case 'location':
          ...
          j.radius && (l.radius = j.radius),
            h.setPosition(
              l,
              new google.maps.LatLng(j.latitude, j.longitude),
              function (a) {
        ...
        case 'map':
          if (void 0 == j) {
            ...
            return (
              (p.formattedAddress = l.locationName),
              (p.addressComponents = l.addressComponents),
              { map: l.map, marker: l.marker, location: p }
            );
          }
          return null;
        case 'autosize':
    ...
    return this.each(function () {
      ...
      if (!c(this)) {
        ...
        d.data('locationpicker', j),
          google.maps.event.addListener(j.marker, 'dragend', function () {
            h.setPosition(j, j.marker.position, function (a) {
              var b = h.locationFromLatLng(j.location);
              a.settings.onchanged.apply(j.domContainer, [b, a.radius, !0]),
                e(j.settings.inputBinding, j);
            });
          }),
          h.setPosition(
            j,
            new google.maps.LatLng(g.location.latitude, g.location.longitude),
            function (a) {
              e(g.inputBinding, j),
                f(g.inputBinding, j),
                a.settings.oninitialized(d);
            },
          );
      }
    });
