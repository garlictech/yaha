  ...
  !(function (a) {
    ...
    (k.VERSION = '1.12.2'),
      (k.DEFAULTS = {
        ...
        multipleSeparator: ', ',
        styleBase: 'btn',
        style: 'btn-default  btn-secondary',
        size: 'auto',
        title: null,
          ...
          var b = this.multiple || this.options.showTick ? ' show-tick' : '',
            ...
            g =
              this.multiple && this.options.actionsBox
                ? '<div class="bs-actionsbox"><div class="btn-group btn-group-sm btn-block"><button type="button" class="actions-btn bs-select-all btn btn-default btn-secondary">' +
                  this.options.selectAllText +
                  '</button><button type="button" class="actions-btn bs-deselect-all btn btn-default btn-secondary">' +
                  this.options.deselectAllText +
                  '</button></div></div>'
                : '',
            h =
              this.multiple && this.options.doneButton
                ? '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm btn-default btn-secondary">' +
