...
class API_Controller extends REST_Controller
{
	...
	function custom_fail_response( $data, $require_convert = true, $message = "" )
	{
		...
		// if there is no data, return error
			...
			$this->error_response( get_msg( 'no_record' ), 404);
	...
	function custom_response_history( $data, $user_id, $require_convert = true )
	{
		...
		$frontend_config_object->is_enable_gps = $frontend_config->gps_enable;
		...
		$frontend_config_object->show_main_menu = $frontend_config->show_main_menu;
		$frontend_config_object->show_special_collections = $frontend_config->show_special_collections;
		$frontend_config_object->show_featured_items = $frontend_config->show_featured_items;
		$frontend_config_object->show_best_choice_slider = $frontend_config->show_best_choice_slider;
