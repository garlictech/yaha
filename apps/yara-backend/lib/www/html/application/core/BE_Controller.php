...
class BE_Controller extends PS_Controller {
	...
	*/
	...
	/**
	 * Edit the exiting record popular category
	 */
	function popular_catedit( $id )
	{
		// check access
		$this->check_access( EDIT );
		...
		// load entry form
		$this->load_template( 'popularcategories/entry_form',$this->data, true );
	}

	/**
	 * Edit the exiting record purchase category
	 */
	function purchased_catedit( $id )
	{
		// check access
		$this->check_access( EDIT );
		...
		// load entry form
		$this->load_template( 'purchasedcategories/entry_form',$this->data, true );
	}
