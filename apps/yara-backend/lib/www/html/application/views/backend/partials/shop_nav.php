			      ...
			      -->
			      	...
			      	<li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<div class="dropdown-divider"></div>
				          	<a class="dropdown-item" href="<?php echo site_url('/admin/frontend_configs');?>"> 
								  		&#10148; <?php echo get_msg('frontend_setting_module'); ?>
							</a>
							<div class="dropdown-divider"></div>
				          	<a class="dropdown-item" href="<?php echo site_url('/admin/thumbnail_generators');?>"> 
								  		&#10148; <?php echo get_msg('thumbnail_generators_module'); ?>
							</a>
				        </div>
			      	</li>
			      	<li class="nav-item">
			      	...
			      	<li class="nav-item dropdown">
			        	...
			        	<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		            		<a class="dropdown-item" href="<?php echo site_url('/admin/popularcategories');?>"> 
		    	  					&#10148; <?php echo get_msg('popular_cat_module'); ?>
		    	  			</a>

		    	  			<div class="dropdown-divider"></div>
		            		<a class="dropdown-item" href='<?php echo site_url('/admin/purchasedcategories');?>'> 
		  				  		&#10148; <?php echo get_msg('purchase_cat_module'); ?>
		  				    </a>
