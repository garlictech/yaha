		    ...
		    <div class="signup-form">
		    	<div class="register-form">
					...
					<div class="form-submit">
						 <input type="submit" value="<?php echo get_msg('go_to_paypal_label')?>" class="btn btn-outline-primary" data-toggle="modal" data-target="#paymentModal" name="save">
...
<div class="modal fade"  id="paymentModal">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
	  ...
	  <img src="<?php echo img_url( "demo-alert.jpg" ); ?>" width="35", height="35" style="padding: 7px;">
        <h5 class="modal-title"><?php echo get_msg('alert_for_payment');?></h5>
      ...
      <div class="modal-body">
        ...
        <p style="margin : 0"> <?php echo get_msg('demo_payment_desc'); ?> </p>
      </div>

      <div class="modal-footer">
        <a type="button" class="btn btn-primary btn-payment"><?php echo get_msg('btn_understand_cancel');?></a>
      </div>
...
<script>
	$('.btn-payment').click(function(e){
		...
		var action = '<?php echo site_url('/load_paypal');?>';
