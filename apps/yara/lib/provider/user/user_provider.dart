...
import 'package:fluttermultirestaurant/viewobject/holder/apple_login_holder.dart';
import 'package:fluttermultirestaurant/viewobject/holder/facebook_login_user_holder.dart';
import 'package:fluttermultirestaurant/viewobject/holder/fb_login_parameter_holder.dart';
import 'package:fluttermultirestaurant/viewobject/holder/google_login_parameter_holder.dart';
import 'package:fluttermultirestaurant/viewobject/holder/user_login_parameter_holder.dart';
import 'package:fluttermultirestaurant/viewobject/holder/user_register_parameter_holder.dart';
...
class UserProvider extends PsProvider {
  ...
  late ShippingArea selectedArea;
...
late  StreamController<PsResource<User>> userListStream;
  ...
  LatLng getUserLatLng(PsValueHolder psValueHolder) {
    if (
      ...
      return LatLng(double.parse(psValueHolder.lat!), double.parse(psValueHolder.lng!));
    }
