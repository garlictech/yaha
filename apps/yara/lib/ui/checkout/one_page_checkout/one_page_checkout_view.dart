...
import 'package:fluttermultirestaurant/repository/schedule_header_repository.dart';
...
import 'package:fluttermultirestaurant/ui/common/dialog/demo_warning_dialog.dart';
...
import 'package:fluttermultirestaurant/viewobject/holder/billing_to_call_back_holder.dart';
...
import 'package:fluttermultirestaurant/viewobject/holder/order_location_call_back_holder.dart';
import 'package:fluttermultirestaurant/viewobject/holder/order_time_call_back_holder.dart';
import 'package:fluttermultirestaurant/viewobject/holder/payment_call_back_holder.dart';
...
class _OnePageCheckoutViewState extends State<OnePageCheckoutView> {
  ...
  dynamic payFlutterWave() async {
    ...
    final FlutterwaveStyle style = FlutterwaveStyle(
        ...
        appBarTitleTextStyle: Theme.of(context).textTheme.headline6!.copyWith(
              color: PsColors.mainColorWithWhite,
              fontWeight: FontWeight.bold,
            ),
          ...
          return ConfirmDialogView(
              ...
              onAgreeTap: () async {
                ...
                //   payWithPayStack();
                  ...
                  payWithCashPickUp();
                } else if (paymentController.text == Utils.getString(context, 'checkout3__cod') && userProvider!.isCash) {
                  payWithCash();
        ...
        if (result != null && result is OrderTimeCallBackHolder) {
          setState(() {
            ...
            if (widget.userProvider!.selectedRadioBtnName ==
              ...
              widget.updateDateTime!(widget.firstTimeOrderController.text);
            }
            if (widget.userProvider!.selectedRadioBtnName ==
