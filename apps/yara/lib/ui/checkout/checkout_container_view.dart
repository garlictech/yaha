...
import 'package:fluttermultirestaurant/provider/coupon_discount/coupon_discount_provider.dart';
...
import 'package:fluttermultirestaurant/provider/token/token_provider.dart';
    ...
    return MultiProvider(
        providers: <SingleChildWidget>[
          ChangeNotifierProvider<CouponDiscountProvider>(
              ...
              create: (BuildContext context) {
                couponDiscountProvider =
                    CouponDiscountProvider(repo: couponDiscountRepo!, psValueHolder: valueHolder!);
          ...
          ChangeNotifierProvider<TokenProvider>(
              lazy: false,
              create: (BuildContext context) {
                tokenProvider = TokenProvider(repo: tokenRepository, psValueHolder: valueHolder!);
    ...
    if (viewNo < maxViewNo) {
      if (viewNo == 3) {
        ...
        if (checkout3ViewState.isCheckBoxSelect) {
          ...
          //                           checkout3ViewState.memoController.text,
          //                       paystackKey:
          //                           shopInfoProvider!.psValueHolder!.paystackKey!,
          //                       publishKey: valueHolder!.publishKey!,
          //                       isClickPickUpButton: checkout1ViewState
          //                           .userProvider.isClickPickUpButton,
          //                       deliveryPickUpDate:
        ...
        if (!checkout1ViewState.userProvider.hasLatLng(valueHolder) &&
