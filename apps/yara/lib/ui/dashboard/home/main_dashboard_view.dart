...
import 'package:yara/provider/best_choice/best_choice_provider.dart';
import 'package:yara/provider/category/category_provider.dart';
import 'package:yara/provider/product/discount_product_provider.dart';
import 'package:yara/provider/product/search_product_provider.dart';
import 'package:yara/provider/product/trending_product_provider.dart';
import 'package:yara/provider/shop/new_shop_provider.dart';
import 'package:yara/provider/shop/trending_shop_provider.dart';
...
import 'package:yara/ui/best_choice/best_choice_list_item_view.dart';
import 'package:yara/ui/best_choice/best_choice_slider/best_choice_slider.dart';
import 'package:yara/ui/category/item/category_horizontal_list_item.dart';
import 'package:yara/ui/common/dialog/choose_attribute_dialog.dart';
import 'package:yara/ui/common/dialog/confirm_dialog_view.dart';
import 'package:yara/ui/common/dialog/rating_dialog/core.dart';
import 'package:yara/ui/common/dialog/rating_dialog/style.dart';
...
import 'package:yara/ui/map/home_location_view.dart';
import 'package:yara/ui/product/item/product_horizontal_list_item.dart';
import 'package:yara/ui/shop_list/item/shop_horizontal_list_item.dart';
import 'package:yara/utils/utils.dart';
import 'package:yara/viewobject/basket.dart';
import 'package:yara/viewobject/basket_selected_add_on.dart';
import 'package:yara/viewobject/basket_selected_attribute.dart';
...
debugPrint("******1 $valueHolder");
debugPrint("******2 ${valueHolder!.shopLoadingLimit}");
debugPrint("******3 ${valueHolder!.categoryLoadingLimit}");
debugPrint("******3 ${valueHolder!.showBestChoiceSlider}");
