...
import 'package:fluttermultirestaurant/provider/transaction/transaction_detail_provider.dart';
import 'package:fluttermultirestaurant/provider/transaction/transaction_header_provider.dart';
import 'package:fluttermultirestaurant/provider/transaction/transaction_status_provider.dart';
...
import 'package:fluttermultirestaurant/ui/common/dialog/delivery_boy_rating_input_dialog.dart';
...
import 'package:fluttermultirestaurant/ui/transaction/detail/transaction_item_view.dart';
                  ...
                  child: CustomScrollView(
                      ...
                      slivers: <Widget>[
                        ...
                        if (widget.transaction.refundStatus == PsConst.ONE)
                           SliverToBoxAdapter(child:_RefundButtonWidget(
                        ...
                        if (widget.transaction.ratingStatus == PsConst.ONE)
                          SliverToBoxAdapter(child: _ReviewButtonWidget(
                            transaction: widget.transaction,
                          ))
                        else
                          SliverToBoxAdapter(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      titleText: Utils.getString(
          context, 'transaction_detail__give_review'),
      onPressed: () async {
                  ...
                  child: Container(
                    ...
                    child: Text(
                      transaction.updatedDate == ''
                          ? ''
                          : Utils.getDateFormat(transaction.updatedDate!, valueHolder),
                      style: Theme.of(context)
                          .textTheme
                          .caption!
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
          ...
          border:
              Border.all(color: PsColors.mainLightColor),
        ),
        child: Align(
            alignment: Alignment.center,
          child: Text(
            Utils.getString(context, 'refund_status_refunded'),
            style: Theme.of(context)
                .textTheme
                .subtitle2!
                .copyWith(color: PsColors.mainColor)
            ...
            if (widget.transactionHeader.id != '') {
              if (await Utils.checkInternetConnectivity()) {
                ...
                final PsResource<TransactionHeader> _transactionHeader =
                    await provider
                        .postRefund(widget.transactionHeader.id!);
                ...
                if (_transactionHeader != null) {
                  ...
                  setState(() {});
                  transactionDetailProvider.resetTransactionDetailList(
                      ...
                      builder: (BuildContext context) {
                        return SuccessDialog(
                          message: Utils.getString(context,
                              'success_dialog__refund_success'),
                        );
                      });
                } else {
                  PsProgressDialog.dismissDialog();
                  ...
                  showDialog<dynamic>(
                      ...
                      builder: (BuildContext context) {
                        return ErrorDialog(
                          message:
                              Utils.getString(context, 'refund__fail'),
                        );
                      });
                }
              } else {
