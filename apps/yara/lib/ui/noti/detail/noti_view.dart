...
import 'package:fluttermultirestaurant/provider/noti/noti_provider.dart';
...
import 'package:fluttermultirestaurant/viewobject/holder/noti_post_parameter_holder.dart';
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            widget.noti!.addedDate == ''
                                ? ''
                                : Utils.getDateFormat(widget.noti!.addedDate!, provider.psValueHolder!),
                            maxLines: 2,
